          ...
          <div className="flex justify-between h-16 ">
            <div className="flex items-center">
              <Link to="/dashboard" className="flex-shrink-0 flex items-center">
                ...
                <span className="font-bold text-quantum-DEFAULT text-xl dark:text-white">Quantum Tutor</span>
              </Link>
            </div>
            ...
            <div className="flex items-center md:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 dark:hover:bg-gray-800 dark:text-whitehover:text-quantum-DEFAULT hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-quantum-light"
              >
          ...
          <div className="md:hidden">
            <div className="pt-2 pb-3 space-y-1">
              <Link
                ...
                className={`${
                  location.pathname === '/dashboard'
                    ...
                    : 'text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-white'
              ...
              <button
                ...
                className="w-full text-left text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-white block px-3 py-2 rounded-md text-base font-medium"
              >
                Sair
              </button>
            </div>
            <div className="pt-4 pb-3 border-t border-gray-200">
              <div className="flex items-center px-4">
                ...
                <div className="ml-3">
                  <div className="text-base font-medium text-gray-800 dark:text-white">{currentUser?.name || 'Usuário'}</div>
      ...
      <div className="flex-grow flex">
        ...
        <nav className="hidden md:block w-64 bg-white border-r border-gray-200 dark:border-gray-700 pt-5 dark:bg-dark-darker">
          <div className="px-4 space-y-1">
            ...
            >
              <ProfileIcon />
              <span className="ml-3">Perfil e Configurações</span>
            </Link>
            <button
              onClick={handleLogout}
              className="w-full text-left text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md"
            >
              <LogoutIcon />
